        ...
        <section className="max-container padding-container flex flex-col gap-20
         py-10 pb-32 md:gap-28 lg:py-20 xl:flex-row">
            ...
            <div className="relative z-20 flex flex-1 flex-col xl:w-1/2">
                ...
                />
                <h1 className='bold-52 lg:bold-88'>Drakensberg Camp Area</h1>
                <p className="regular-16 mt-6 text-gray-30 xl:max-w-[520px]">
                    We want to be on each of your jounreys seeking the satisfaction of seeing the incorruptible
                ...
                <div className="my-11 flex flex-wrap gap-5">
                    ...
                    <p className='bold-16 lg:bold-20 text-blue-70'>
                        199k
                        <span className='regular-16 lg:regular-29 ml-1 underline'>Excellent reviews</span>
                    </p>
                </div>
            ...
            <div className="relative flex flex-1 items-start">
                <div className="relative flex z-10 w-[268px] flex-col gap-8
                    ...
                    <div className="flexBetween">
                        <div className="flex flex-col">
                            ...
                            <p className="bold-20 text-white">132.28 km</p>
                        </div>
                        <div className="flex flex-col">
